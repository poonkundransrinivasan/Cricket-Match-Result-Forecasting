...
# Later, when you want to use them on new data
loaded_label_encoder = joblib.load('data/label_encoder.joblib')
loaded_min_max_scaler = joblib.load('data/min_max_scaler.joblib')

# Transform new data using the loaded objects
# new_encoded_labels = loaded_label_encoder.transform(new_labels)
# new_scaled_data = loaded_min_max_scaler.transform(new_data)
